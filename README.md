# WhatsIndex — Distribuição

Repositório de distribuição do **WhatsIndex**, sistema de análise forense de logs telemáticos WhatsApp.

As versões estão disponíveis em [Releases](../../releases).
